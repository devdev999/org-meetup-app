...
ALTER TABLE "gatherings" ADD CONSTRAINT "gatherings_organisation_id_audience_site_id_sites_organisation_id_id_fk" FOREIGN KEY ("organisation_id","audience_site_id") REFERENCES "public"."sites"("organisation_id","id") ON DELETE no action ON UPDATE no action;