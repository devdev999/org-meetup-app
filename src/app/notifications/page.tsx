...
export default async function NotificationsPage() {
  ...
  return (
    <main>
      ...
      <p className="muted">Telegram notices arrive immediately. Email for joins, waitlist promotions and cancellations arrives immediately. Other email notices arrive in a daily digest at 09:00 UTC.</p>
