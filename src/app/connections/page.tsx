    ...
    <main>
      ...
      {connections.length === 0 ? (
        ...
        connections.map((connection) => (
          <section key={connection.member.memberId}>
            <h2>
              {connection.member.profileVisible ? (
                <Link href={`/members/${connection.member.memberId}`}>
            ...
            <ul className="meetup-list">
              {connection.occurrences.map((occurrence) => (
