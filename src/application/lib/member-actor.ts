...
export async function asMember(deps: Deps, memberId: string): Promise<MemberActions | undefined> {
  ...
  return {
    ...
    inviteSuggestedMemberToEvent: (id, memberId, previousInviteId) => withNotices(id, () => inviteMember(deps, actor, id, memberId, { previousInviteId, fromSuggestion: true }, "event")),
