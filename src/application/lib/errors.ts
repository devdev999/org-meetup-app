export type InvalidInputCode = "unknown-department" | "unknown-site" | "invalid-roster" | "stale-roster" | "invalid-list-entry" | "duplicate-list-entry" | "invalid-interest" | "unknown-interest" | "alias-conflict" | "interest-name-conflict" | "invalid-meetup" | "invalid-telegram-link" | "invalid-notice-preference";
