...
The urgent notice kinds are meetup-joined, meetup-promoted, meetup-cancelled, meetup-edited, invite-received and invite-accepted. Enabled email for these kinds sends immediately. Email for meetup-left, meetup-handed-over and invite-declined batches into the daily digest. Telegram sends every enabled kind immediately under [ADR 0004](0004-telegram-primary-notification-channel.md), so this decision governs email timing only.
