...
A split preserves later Member edits and removals. It restores original declarations only when the Member has left the merged declaration unchanged. The same rule preserves a Host's later changes to the affected relevant Interests on a Meetup or Event.
